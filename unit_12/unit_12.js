...
function generateElement2(elem) {
    ...
    return function (t) {
      let elblock = document.createElement(elem)
      elblock.innerHTML = t
      return elblock
    }
}
...
// Task 10
// Напишите функцию замыкание generateMonth, внутри которой создан массив month с названиями месяцев и return анонимной функции, которая получает аргумент n и возвращает month[n-1] месяц.
