...
document.querySelector(".b-1").addEventListener("click", function () {
  document.querySelector(".out-1").innerHTML = t1(5, 10);
});
...
document.querySelector(".b-2").addEventListener("click", function () {
  document.querySelector(".out-2").innerHTML = t2(15, 25);
});
...
document.querySelector(".b-3").addEventListener("click", function () {
  document.querySelector(".out-3").innerHTML = t3(24, 0, 25);
});
...
function t5(block) {
  let out5 = document.querySelector(block);
  if (out5) {
    return true;
  } else {
    return false;
...
document.querySelector(".b-6").addEventListener("click", function () {
  document.querySelector(".out-6").innerHTML = t6([1,2,3,4,5]).join(' ')
 });
...
function t9(arr, number){
  arr.push(number)
  return arr
}

document.querySelector(".b-9").addEventListener("click", function () {
  document.querySelector(".out-9").textContent = t9([1,2,3,4], 5).join(' ')
 })
...
function t10(arr, ...arrfree){
arr.push(...arrfree)
return arr
}

document.querySelector(".b-10").addEventListener("click", function () {
  document.querySelector(".out-10").textContent = t10([1,2,3,4], 5,6,7).join(' ')
 })